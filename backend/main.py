...
EMAIL_ENABLED = True
EMAIL_SENDER = "dharshinia.2025ibm@gmail.com"          # <-- the Gmail address you generated the App Password for
EMAIL_APP_PASSWORD = "udvezmrpgbbvxazf"        # <-- the 16-character App Password (no spaces)
EMAIL_RECIPIENT = "dharshinia.2025ibm@gmail.com"       # <-- who should receive the alert (can be same as sender)
